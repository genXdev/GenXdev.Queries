...
@{
    ...
    Description       = 'Provides a collection of cmdLets that help finding resources and information on the internet'
    ...
    RequiredModules = @(@{ModuleName = 'GenXdev.Helpers'; ModuleVersion = '1.0.0'},@{ModuleName = 'GenXdev.Webbrowser'; ModuleVersion = '1.0.0'})
    ...
    FileList          = @("GenXdev.Queries.psd1", "GenXdev.Queries.psm1", "LICENSE", "license.txt", "README.md")
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ProjectUri               = 'https://github.com/renevaessen/GenXdev.Queries'
    ...
    HelpInfoURI       = 'https://github.com/renevaessen/GenXdev.Queries/blob/main/README.md#syntax'
