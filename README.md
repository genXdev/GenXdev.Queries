...
| [Open-BingChatQuery](#Open-BingChatQuery) | bc | Opens a Bing chat query in a webbrowser, in a configurable manner, using commandline switches |
...
### SYNTAX
````PowerShell
Open-BingChatQuery [-Queries] <String[]> [-Monitor <Int32>] [<CommonParameters>]
````
